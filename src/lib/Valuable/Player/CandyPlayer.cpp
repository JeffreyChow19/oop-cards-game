...
void CandyPlayer::setPoint(int point)
{
    this->point_ = point;
}

void CandyPlayer::addPoint(long long pointVal)
{
    this->point_ += pointVal;
}

long long CandyPlayer::getPoint() const
{
    return this->point_;
}

string CandyPlayer::getAbility()
{
    return ability_;
}

void CandyPlayer::setAbility(string ability)
{
    this->ability_ = ability;
}

bool CandyPlayer::getAbilityStatus()
{
    return this->abilityStatus_;
}

void CandyPlayer::setAbilityStatus(bool status)
{
...
bool CandyPlayer::getHasPlayed()
{
    return this->hasPlayed_;
}

void CandyPlayer::print()
{
    Coloring clr;
...
void CandyPlayer::deleteMinColorFromCombo(vector<ColorCard> &combo, int limit)
{
    if (combo.size() == limit)
    {
...
Combo *CandyPlayer::checkPlayerCombo(TableDeck &tableDeck)
{
...
Flush *CandyPlayer::checkPlayerFlush(TableDeck &tableDeck)
{
...
FourOfAKind *CandyPlayer::checkPlayerFourOfAKind(TableDeck &tableDeck)
{
...
HighCard *CandyPlayer::checkPlayerHighCard()
{
...
Pair *CandyPlayer::checkPlayerPair(TableDeck &tableDeck)
{
    // sort ascending
...
Straight *CandyPlayer::checkPlayerStraight(TableDeck &tableDeck)
{
    sort(this->deck.begin(), this->deck.end(), ColorCard::compareByValueThenColor);
    // insert decks to map
...
ThreeOfAKind *CandyPlayer::checkPlayerThreeOfAKind(TableDeck &tableDeck)
{
    map<int, vector<ColorCard>> allFreq;
    map<int, vector<ColorCard>> playerFreq;
...
FullHouse *CandyPlayer::checkPlayerFullHouse(TableDeck &tableDeck)
{
    map<int, vector<ColorCard>> allFreq;
    map<int, vector<ColorCard>> playerFreq;
    for (auto &card : this->deck)
...
TwoPair *CandyPlayer::checkPlayerTwoPair(TableDeck &tableDeck)
{
    sort(this->deck.begin(), this->deck.end(), ColorCard::compareByValueThenColor);
    sort(tableDeck.getDeck().begin(), tableDeck.getDeck().end(), ColorCard::compareByValueThenColor);
...
StraightFlush *CandyPlayer::checkPlayerStraightFlush(TableDeck &tableDeck)
{
